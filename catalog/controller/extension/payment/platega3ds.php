...
class ControllerExtensionPaymentPlatega3ds extends Controller {
	...
	public function index(){
        ...
        return $this->load->view('extension/payment/platega3ds', $data);
	}
    ...
    public function pay(){
        ...
        $curl_data = array(
            ...
            "failedUrl" => "https://galaxy-game.ru/index.php?route=extension/payment/platega3ds/platega3ds_fail",
            /*
            "payload" => array(
        ...
        $this->log->write("===_________ platega3ds ___________===");
        ...
        $this->response->setOutput($this->load->view('extension/payment/platega3ds', $data));
        */
	...
	public function response(){
		$this->cart->clear();
        $this->log->write("RESPONSE platega3ds");
	...
	public function callback(){
        $this->log->write("======= CALLBACK platega3ds ==========");
        $this->log->write("post");
        ...
        $this->log->write("get");
        $this->log->write($_GET);        
        $this->log->write("======= CALLBACK platega3ds END ==========");

	}

    public function platega3ds_fail(){
        $this->log->write("======= platega3ds_FAIL ==========");
        $this->log->write("post");
        $this->log->write($_POST);
        $this->log->write("get");
        $this->log->write($_GET);
    ...
    public function platega3ds_fin(){
        $this->log->write("======= platega3ds_fin ==========");
        $this->log->write("post");
        $this->log->write($_POST);
        $this->log->write("get");
        $this->log->write($_GET);
